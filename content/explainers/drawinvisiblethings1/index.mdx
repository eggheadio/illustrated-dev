...
As the art director and lead illustrator I'm the one in charge of all the shiny pictures you'll see around the site. These images are all course illustrations - they're essentially album art for our in-depth video workshops. <Tooltip tiptext={<span>I don't make all of our illustrations  – I have a wonderful team that includes <a href="#">Maxime</a> and <a href="#">Aleksander</a> who help with the load.</span>}>1</Tooltip>
...
![](EGH_React_Transitions_424@2x.png)
[Create Smooth, Performant Transitions with React Transition Group](https://egghead.io/courses/create-smooth-performant-transitions-with-react-transition-group-v2)
...
We teach web development, which means the particular flavour of invisible things I draw are programming concepts, techniques, frameworks, and tools.
...
This is a long overdue case study showing the process of illustrating a course.
...
This is not that blog post. <Tooltip tiptext="If you would like to learn how, take Sam Neilson's Fundamentals of Lighting on Schoolism. It will drown you in the minutiae of rendering light on surfaces. Also check out the Resources page.">2</Tooltip>
