...
![Building a second brain (BASB) illustrated notes on the PARA system of organising content projects, areas, resources, and archives](./BASB_P1_1.png)
![BASB sketchnotes on putting projects in priority order and defining the desired outcome](./BASB_P1_2.png)
![BASB sketchnotes on wiping the slate clean and setting up PARA as a folder structure](./BASB_P1_3.png)
![BASB sketchnotes on creating metaplans before you start your project](./BASB_P1_4.png)
