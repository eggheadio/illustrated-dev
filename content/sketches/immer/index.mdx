...
**Immutability** simply means making a second copy of things before you change them.  
It's the same as copying and pasting a new _ImportantThing_Version2_Draft.md_ document before attempting to fix your terribly written blog post.

Writing [immutable code](https://en.wikipedia.org/wiki/Immutable_object) is a [wildly](https://medium.com/tribalscale/understanding-immutability-fdd627b66e58) [popular](https://itnext.io/why-concept-of-immutability-is-so-damn-important-for-a-beginner-front-end-developer-8da85b565c8e) concept. And generally a good idea when you don't want to muck everything up.  
...
Behind the scenes in apps we have to account for every state an app could be in (which gets expontential very quicky).  
This is usually called "[managing state](https://codeburst.io/state-management-in-javascript-15d0d98837e1)" and [appears to be a neverending problem](https://medium.com/razroo/the-history-of-javascript-state-management-in-2019-161491d588ed).

---

Michel Weststrate just came up with an elegant new solution though.

We now have a fancy new tool called [Immer](https://immerjs.github.io/immer/docs/introduction) that helps manage immutable state in Javascript apps.
