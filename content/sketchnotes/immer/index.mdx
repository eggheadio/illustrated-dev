...
The course is up as a **free community resource** on egghead, and is aptly named [Immutable JavaScript Data Structures with Immer](https://egghead.io/courses/immutable-javascript-data-structures-with-immer?af=54fd64) 

<Link to="https://egghead.io/courses/immutable-javascript-data-structures-with-immer?af=54fd64">
...
If you're currently allergic to state & immutability as well, it might be the time to re-test your tolerances and [see if Immer can help cure it](https://egghead.io/courses/immutable-javascript-data-structures-with-immer). 
