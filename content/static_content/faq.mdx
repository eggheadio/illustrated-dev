...
import FAQDiagram from '../../static/images/illustratednotes-diagram.png'

### What tools do you use to make these?
Primarily my brain and upper body limbs.  
With a little help from [Procreate](https://procreate.art/) on an iPad Pro.  
I do a little colour and brightness editing in Photoshop as well, but it's a pretty minor step.
...
You'll notice almost all my illustrated notes are of egghead courses, and we include them on the course pages on our main site.  
...
Not really. Infographics have [a particular aesthetic](https://www.pinterest.com/visualistan/latest-infographics/) that makes my eyes bleed.
...
Not really. If we define 'sketchnotes' as true *sketches* – unrefined, unplanned visual scribbles – these don't fit.
...
<!-- Image for this in the static/images folder -->

### Okay fine. So what buzzword am I supposed to use to describe these?
I think about this too much, but I like **illustrated notes**, or **illustrated explanations**.  I also like **visual essays**, but use that to describe things I make that have a more opinionated point of view.  
Suggestions for better words [welcome and accepted](mailto:maggie@illustrated.dev) 😉

### Have a question I haven't answered?
[Feel free to ask it](mailto:maggie@illustrated.dev)
